__title__ = 'arcgis-raster-data-management'
__version__ = '0.0.0'
...
def example_function(in_path: Union[str, Path]) -> pd.DataFrame:
    ...
    .. code-block:: python
        ...
        from raster_mgmt import example_function
...
class ExampleObject(object):
    ...
    def example_static_function(in_path: Union[str, Path]) -> pd.DataFrame:
        ...
        .. code-block:: python
            ...
            from raster_mgmt import ExampleObject
    ...
    def example_class_method(cls):
        ...
        .. code-block:: python
            ...
            from from raster_mgmt import ExampleObject
